...
// // https://drive.google.com/file/d/1x_ZMdGzBXt4_O16J0yLASX7IYC1I1dcd/view?usp=share_link

// const xablau2 = () => {
//   const oi = fetch('./app-Bookmarks.json')
...
//                                                 // // outra opção:
//                                                 // const all = `${element.path} - ${element.text}`;
//                                                 // console.log(all);
//         });
//       return all;
//     });
...
//     // divText.innerText = book; //qualquer problema do css não funcionar e o título ficar aparecendo,
